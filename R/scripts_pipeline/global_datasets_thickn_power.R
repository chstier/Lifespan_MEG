...
### and concatenates with frequency-specific global MEG power
...
full_power_th = cbind(all_power, data$Global)
head(full_power_th) 
names(full_power_th)[15] = 'thickness' 

# get intracranial volume
icv = read.csv("/Users/christinastier/Documents/Projects/Age/R_camcan/files/global/icv/icv_all_subjects.csv", header = FALSE)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
icv = as.data.frame(icv)
str(icv)

# concatenate with dataset and rename variable
full_power_th = cbind(full_power_th, icv$V1)
head(full_power_th) 
names(full_power_th)[16] = 'tiv' 
...
save(full_power_th, file = "power_thickness_global_allcohorts.Rda") 
