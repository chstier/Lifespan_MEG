function [ stat_out ] = cs_nmri_statistics( all_subjects, opt, params )
...
%% CS: changed the order of the output to fit to my R scripts - replaced the main loop at L 126 (compare with HIH-scripts)
