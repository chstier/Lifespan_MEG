function [ subject, data ] = cs_nmri_make_hdm_suma_compile(subject, data, params)
...
%% again add params to subject-struct
...
%% Meshing Brain - needed for BEM/singleshell models and visualization
cfg           = [];
