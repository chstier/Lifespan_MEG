function [ subject ] = cs_nmri_qcplot_power_mag(subject, data, params, title_txt)
...
if (~exist('title_txt','var') || isempty(title_txt)) 
 title_txt='artifact_pow_mag_plot';
end
...
if (isfield(params,'QC_plots') && params.QC_plots==1)
 % make plot
  ...
  %system(['eog ' fullfile(subject.QCdir,['artifact_pow_mag_plot_' subject.id '_' subject.exam_id '.png'])])
