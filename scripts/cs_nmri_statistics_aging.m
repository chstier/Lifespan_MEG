function [ stat_out ] = cs_nmri_statistics_aging( all_subjects, cohort_stat, opt, params )
...
%% Written by NF. Modified by Christina Stier, 2020/22
...
if opt.report
 ...
 cohort_stat = char(cohort_stat);
 
 % save as csv
 nf_csvwrite(fullfile(opt.report_dir,[cohort_stat '_metric_summary_' date '.csv']),stat_out);
 

 % and mat
 save(fullfile(opt.report_dir,[cohort_stat '_metric_summary_' date '.mat']),'stat_out');
